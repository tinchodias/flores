...
public class ShowDetailOnSelectionAction implements Action {
	...
	public ShowDetailOnSelectionAction(SearchUI searchUI, ValueHolder valueHolder, Action onSelectionAction, MessageId messageId) {
